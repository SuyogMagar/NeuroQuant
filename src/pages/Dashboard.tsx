    ...
    <DashboardLayout>
      <div className="p-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <Button className="!bg-gold !text-navy !hover:bg-gold/90 !text-xl !font-bold !px-10 !py-4 !rounded-full !shadow-lg">
            New Investment
          </Button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="bg-white/5 backdrop-blur-lg border border-white/10">
            ...
            <CardContent>
              <div className="text-4xl font-extrabold text-white">{portfolioValue}</div>
          ...
          <Card className="bg-white/5 backdrop-blur-lg border border-white/10">
            ...
            <CardContent>
              <div className="text-4xl font-extrabold text-white">{totalInvestments}</div>
              <p className="text-lg text-white/50">Active funds</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/5 backdrop-blur-lg border border-white/10">
            ...
            <CardContent>
              <div className="text-4xl font-extrabold text-green-400">{totalReturn}</div>
              <p className="text-lg text-white/50">Last 12 months</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/5 backdrop-blur-lg border border-white/10">
            ...
            <CardContent>
              <div className="text-4xl font-extrabold text-white">$105,000</div>
              <p className="text-lg text-white/50">Ready to invest</p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="bg-white/5 backdrop-blur-lg border border-white/10">
            <CardHeader>
              <div className="flex justify-between items-center">
                ...
                <BarChart className="h-7 w-7 text-white/70" />
              </div>
            </CardHeader>
            <CardContent>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="bg-white/5 backdrop-blur-lg border border-white/10">
            <CardHeader>
              <div className="flex justify-between items-center">
                <CardTitle className="text-2xl font-bold text-white">Your Investments</CardTitle>
                <Link to="/my-investments" className="text-gold hover:text-gold/80 text-lg flex items-center">
                  View All <ArrowRight className="h-6 w-6 ml-2" />
                </Link>
              </div>
            </CardHeader>
            <CardContent>
                ...
                {[
                  ...
                  <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-white/10 hover:bg-white/15 transition-colors">
                    ...
                    <div className="flex items-center">
                      ...
                      <Button variant="outline" size="sm" className="!border-gold !text-gold !hover:bg-gold !hover:text-navy !text-xl !font-bold !px-8 !py-3 !rounded-full !shadow-md">
                        Details
                      </Button>
                    </div>
                  </div>
